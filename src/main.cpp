...
void ParseArg(int argc, char *argv[], char *filename, int &len, int &sz, int &CHOOSE)
{
	...
	opts.add_options()("memory,m", value<int>()->required(), "memory size")("version,v", value<int>()->required(), "version")("keylen,l", value<int>()->required(), "keylen")("filename,f", value<string>()->required(), "trace file")("help,h", "print help info");
